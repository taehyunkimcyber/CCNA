...
Complete Lab 01 after the VLANs, trunking, and Spanning Tree labs. EtherChannel
combines several physical links into one logical link, so a solid understanding
of trunks and STP will make the verification output easier to interpret.
