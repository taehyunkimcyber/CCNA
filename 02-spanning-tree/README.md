...
1. Complete Lab 01 after the VLANs and trunking labs.
2. Pay close attention to `show spanning-tree vlan 10`; that command is the main point of the lab.

EtherChannel is intentionally not included here. That belongs in
`03-etherchannel`.
