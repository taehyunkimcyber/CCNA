...
- Packet Tracer activity: save your file here as `packet-tracer/02-spanning-tree.pkt`
...
In Packet Tracer, the physical layout can look like a triangle:

- SW1 connects to SW2.
- SW2 connects to SW3.
- SW3 connects back to SW1.
...
5. Save the Packet Tracer project as `02-spanning-tree.pkt`.
...
Shut down one forwarding trunk and watch STP recover.
